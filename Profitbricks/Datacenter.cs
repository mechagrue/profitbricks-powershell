...
namespace Profitbricks
{
    ...
    public class GetDatacenter : Cmdlet
    {
        ...
        /// <summary>
        /// <para type="description">Virtual data center ID. If this parameter is not passed, the commandlet will return a list of all data centers from your ProfitBricks instance.</para>
        /// </summary>
